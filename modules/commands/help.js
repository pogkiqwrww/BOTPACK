...
━━━━━━━━━━━━━━ 
𝗕𝗼𝘁 𝗢𝘄𝗻𝗲𝗿: https://facebook.com/johnveuss`;


    var link = [
"https://i.postimg.cc/xTnmddD4/Im-Nayeon-Nayeon-GIF-Im-Nayeon-Nayeon-Kpop-discover-and-share-GIFs.gif",
"https://i.postimg.cc/6Q0SDqKx/chaeyoung-more-more-concept-film-pix-wallpapers-Chaeyoung-ggs-gif-GIFs-kpop-mo.gif",
"https://i.postimg.cc/x84qg98K/Twice-Dahyun-GIF-Twice-Dahyun-Kiss-discover-and-share-GIFs.gif",
"https://i.postimg.cc/2ybVJYv7/Mina-Myoui-Mina-GIF-Mina-Myoui-Mina-Twice-Discover-Share-GIFs.gif",
"https://i.postimg.cc/qMKPL7gM/Sana-Minatozaki-GIF-Sana-Minatozaki-Discover-Share-GIFs.gif",
    ]
...
"https://i.imgur.com/rC2epSM.gif",
    ...
    var callback = () => api.sendMessage({ body: leiamname, attachment: fs.createReadStream(__dirname + "/cache/loidbutter.gif")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/loidbutter.gif"), event.messageID);
    return request(encodeURI(link[Math.floor(Math.random() * link.length)])).pipe(fs.createWriteStream(__dirname + "/cache/loidbutter.gif")).on("close", () => callback());
};